 ...
 * </pre>
 *
 * Protobuf type {@code pipelines.instance.v1alpha1.Instance}
 */
public final class Instance extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:pipelines.instance.v1alpha1.Instance)
    InstanceOrBuilder {
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.Builder subBuilder = null;
            if (gitProvider_ != null) {
              subBuilder = gitProvider_.toBuilder();
            }
            gitProvider_ = input.readMessage(io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return io.cuemby.pipelines.instance.v1alpha1.InstanceProto.internal_static_pipelines_instance_v1alpha1_Instance_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.cuemby.pipelines.instance.v1alpha1.Instance.class, io.cuemby.pipelines.instance.v1alpha1.Instance.Builder.class);
  }
   ...
   */
  @java.lang.Override public io.cuemby.pipelines.instance.v1alpha1.InstanceType getTypeSource() {
    @SuppressWarnings("deprecation")
    io.cuemby.pipelines.instance.v1alpha1.InstanceType result = io.cuemby.pipelines.instance.v1alpha1.InstanceType.valueOf(typeSource_);
    return result == null ? io.cuemby.pipelines.instance.v1alpha1.InstanceType.UNRECOGNIZED : result;
  }

  public static final int GIT_PROVIDER_FIELD_NUMBER = 4;
  private io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider gitProvider_;
  /**
   ...
   */
  @java.lang.Override
  public io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider getGitProvider() {
    return gitProvider_ == null ? io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.getDefaultInstance() : gitProvider_;
  }
  /**
   * <code>.pipelines.instance.v1alpha1.TypeGitProvider git_provider = 4 [json_name = "gitProvider"];</code>
   */
  @java.lang.Override
  public io.cuemby.pipelines.instance.v1alpha1.TypeGitProviderOrBuilder getGitProviderOrBuilder() {
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (typeSource_ != io.cuemby.pipelines.instance.v1alpha1.InstanceType.INSTANCE_TYPE_UNSPECIFIED.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.cuemby.pipelines.instance.v1alpha1.Instance)) {
      return super.equals(obj);
    }
    io.cuemby.pipelines.instance.v1alpha1.Instance other = (io.cuemby.pipelines.instance.v1alpha1.Instance) obj;
  ...
  public static io.cuemby.pipelines.instance.v1alpha1.Instance parseFrom(
  ...
  public static io.cuemby.pipelines.instance.v1alpha1.Instance parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.cuemby.pipelines.instance.v1alpha1.Instance parseFrom(
  ...
  public static io.cuemby.pipelines.instance.v1alpha1.Instance parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.cuemby.pipelines.instance.v1alpha1.Instance parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static io.cuemby.pipelines.instance.v1alpha1.Instance parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.cuemby.pipelines.instance.v1alpha1.Instance prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:pipelines.instance.v1alpha1.Instance)
      io.cuemby.pipelines.instance.v1alpha1.InstanceOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.cuemby.pipelines.instance.v1alpha1.InstanceProto.internal_static_pipelines_instance_v1alpha1_Instance_descriptor;
    }
    ...
    // Construct using io.cuemby.pipelines.instance.v1alpha1.Instance.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.cuemby.pipelines.instance.v1alpha1.Instance getDefaultInstanceForType() {
      return io.cuemby.pipelines.instance.v1alpha1.Instance.getDefaultInstance();
    }

    @java.lang.Override
    public io.cuemby.pipelines.instance.v1alpha1.Instance build() {
      io.cuemby.pipelines.instance.v1alpha1.Instance result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.cuemby.pipelines.instance.v1alpha1.Instance) {
        return mergeFrom((io.cuemby.pipelines.instance.v1alpha1.Instance)other);
      } else {
    ...
    public Builder mergeFrom(io.cuemby.pipelines.instance.v1alpha1.Instance other) {
      if (other == io.cuemby.pipelines.instance.v1alpha1.Instance.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      io.cuemby.pipelines.instance.v1alpha1.Instance parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.cuemby.pipelines.instance.v1alpha1.Instance) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
     ...
     */
    @java.lang.Override
    public io.cuemby.pipelines.instance.v1alpha1.InstanceType getTypeSource() {
      @SuppressWarnings("deprecation")
      io.cuemby.pipelines.instance.v1alpha1.InstanceType result = io.cuemby.pipelines.instance.v1alpha1.InstanceType.valueOf(typeSource_);
      return result == null ? io.cuemby.pipelines.instance.v1alpha1.InstanceType.UNRECOGNIZED : result;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder setTypeSource(io.cuemby.pipelines.instance.v1alpha1.InstanceType value) {
      if (value == null) {
        throw new NullPointerException();
      }
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider, io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.Builder, io.cuemby.pipelines.instance.v1alpha1.TypeGitProviderOrBuilder> gitProviderBuilder_;
    /**
     * <code>.pipelines.instance.v1alpha1.TypeGitProvider git_provider = 4 [json_name = "gitProvider"];</code>
     * @return Whether the gitProvider field is set.
     */
     ...
     * <code>.pipelines.instance.v1alpha1.TypeGitProvider git_provider = 4 [json_name = "gitProvider"];</code>
     */
    public Builder setGitProvider(io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider value) {
      if (gitProviderBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setGitProvider(
        io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.Builder builderForValue) {
      if (gitProviderBuilder_ == null) {
     ...
     * <code>.pipelines.instance.v1alpha1.TypeGitProvider git_provider = 4 [json_name = "gitProvider"];</code>
     */
    public Builder mergeGitProvider(io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider value) {
      if (gitProviderBuilder_ == null) {
        if (gitProvider_ != null) {
          gitProvider_ =
            io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.newBuilder(gitProvider_).mergeFrom(value).buildPartial();
        } else {
          gitProvider_ = value;
        }
        onChanged();
     ...
     * <code>.pipelines.instance.v1alpha1.TypeGitProvider git_provider = 4 [json_name = "gitProvider"];</code>
     */
    public io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.Builder getGitProviderBuilder() {
    ...
    public io.cuemby.pipelines.instance.v1alpha1.TypeGitProviderOrBuilder getGitProviderOrBuilder() {
      if (gitProviderBuilder_ != null) {
        ...
        return gitProvider_ == null ?
            io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.getDefaultInstance() : gitProvider_;
      }
    }
    /**
     * <code>.pipelines.instance.v1alpha1.TypeGitProvider git_provider = 4 [json_name = "gitProvider"];</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider, io.cuemby.pipelines.instance.v1alpha1.TypeGitProvider.Builder, io.cuemby.pipelines.instance.v1alpha1.TypeGitProviderOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:pipelines.instance.v1alpha1.Instance)
  }

  // @@protoc_insertion_point(class_scope:pipelines.instance.v1alpha1.Instance)
  private static final io.cuemby.pipelines.instance.v1alpha1.Instance DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.cuemby.pipelines.instance.v1alpha1.Instance();
  }

  public static io.cuemby.pipelines.instance.v1alpha1.Instance getDefaultInstance() {
