...
public final class ApplicationOuterClass {
  ...
  public interface ListApplicationOrBuilder extends
      // @@protoc_insertion_point(interface_extends:application.v1alpha1.ListApplication)
      com.google.protobuf.MessageOrBuilder {
   ...
   */
  public static final class ListApplication extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:application.v1alpha1.ListApplication)
      ListApplicationOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use ListApplication.newBuilder() to construct.
    private ListApplication(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return application.v1alpha1.ApplicationOuterClass.internal_static_application_v1alpha1_ListApplication_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return application.v1alpha1.ApplicationOuterClass.internal_static_application_v1alpha1_ListApplication_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              application.v1alpha1.ApplicationOuterClass.ListApplication.class, application.v1alpha1.ApplicationOuterClass.ListApplication.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof application.v1alpha1.ApplicationOuterClass.ListApplication)) {
        return super.equals(obj);
      }
      application.v1alpha1.ApplicationOuterClass.ListApplication other = (application.v1alpha1.ApplicationOuterClass.ListApplication) obj;
    ...
    public static application.v1alpha1.ApplicationOuterClass.ListApplication parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static application.v1alpha1.ApplicationOuterClass.ListApplication parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static application.v1alpha1.ApplicationOuterClass.ListApplication parseFrom(
    ...
    public static application.v1alpha1.ApplicationOuterClass.ListApplication parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static application.v1alpha1.ApplicationOuterClass.ListApplication parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static application.v1alpha1.ApplicationOuterClass.ListApplication parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(application.v1alpha1.ApplicationOuterClass.ListApplication prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:application.v1alpha1.ListApplication)
        application.v1alpha1.ApplicationOuterClass.ListApplicationOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return application.v1alpha1.ApplicationOuterClass.internal_static_application_v1alpha1_ListApplication_descriptor;
      }
      ...
      // Construct using application.v1alpha1.ApplicationOuterClass.ListApplication.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public application.v1alpha1.ApplicationOuterClass.ListApplication getDefaultInstanceForType() {
        return application.v1alpha1.ApplicationOuterClass.ListApplication.getDefaultInstance();
      }

      @java.lang.Override
      public application.v1alpha1.ApplicationOuterClass.ListApplication build() {
        application.v1alpha1.ApplicationOuterClass.ListApplication result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public application.v1alpha1.ApplicationOuterClass.ListApplication buildPartial() {
        application.v1alpha1.ApplicationOuterClass.ListApplication result = new application.v1alpha1.ApplicationOuterClass.ListApplication(this);
        result.id_ = id_;
        result.name_ = name_;
        if (repositoryBuilder_ == null) {
          result.repository_ = repository_;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof application.v1alpha1.ApplicationOuterClass.ListApplication) {
          return mergeFrom((application.v1alpha1.ApplicationOuterClass.ListApplication)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(application.v1alpha1.ApplicationOuterClass.ListApplication other) {
        if (other == application.v1alpha1.ApplicationOuterClass.ListApplication.getDefaultInstance()) return this;
        if (!other.getId().isEmpty()) {
          id_ = other.id_;
          onChanged();
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        application.v1alpha1.ApplicationOuterClass.ListApplication parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (application.v1alpha1.ApplicationOuterClass.ListApplication) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:application.v1alpha1.ListApplication)
    }

    // @@protoc_insertion_point(class_scope:application.v1alpha1.ListApplication)
    private static final application.v1alpha1.ApplicationOuterClass.ListApplication DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new application.v1alpha1.ApplicationOuterClass.ListApplication();
    }

    public static application.v1alpha1.ApplicationOuterClass.ListApplication getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<ListApplication>
        PARSER = new com.google.protobuf.AbstractParser<ListApplication>() {
      @java.lang.Override
      public ListApplication parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new ListApplication(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<ListApplication> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<ListApplication> getParserForType() {
      return PARSER;
    }
  ...
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_application_v1alpha1_ListApplication_fieldAccessorTable;
