...
static const char* PaymentAPIService_method_names[] = {
  ...
  "/payment.v1alpha1.PaymentAPIService/ListCustomers",
...
PaymentAPIService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_CreateInvoice_(PaymentAPIService_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetOrganization_(PaymentAPIService_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetSubscription_(PaymentAPIService_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  ...
  , rpcmethod_GetBilingMonth_(PaymentAPIService_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetPayments_(PaymentAPIService_method_names[10], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListProjects_(PaymentAPIService_method_names[11], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListPayment_(PaymentAPIService_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListSubscriptionItems_(PaymentAPIService_method_names[13], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListCustomers_(PaymentAPIService_method_names[14], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListProjectById_(PaymentAPIService_method_names[15], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateSubscription_(PaymentAPIService_method_names[16], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SetDefaultPaymentMethod_(PaymentAPIService_method_names[17], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteProject_(PaymentAPIService_method_names[18], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeletePayment_(PaymentAPIService_method_names[19], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CancelSubscription_(PaymentAPIService_method_names[20], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteCustomer_(PaymentAPIService_method_names[21], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_InvoiceFilter_(PaymentAPIService_method_names[22], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ConsumeByProject_(PaymentAPIService_method_names[23], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateProject_(PaymentAPIService_method_names[24], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateProject_(PaymentAPIService_method_names[25], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status PaymentAPIService::Stub::ListCustomers(::grpc::ClientContext* context, const ::payment::v1alpha1::ListCustomersRequest& request, ::payment::v1alpha1::ListCustomersResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_ListCustomers_, context, request, response);
}

void PaymentAPIService::Stub::experimental_async::ListCustomers(::grpc::ClientContext* context, const ::payment::v1alpha1::ListCustomersRequest* request, ::payment::v1alpha1::ListCustomersResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_ListCustomers_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::payment::v1alpha1::ListCustomersResponse>* PaymentAPIService::Stub::AsyncListCustomersRaw(::grpc::ClientContext* context, const ::payment::v1alpha1::ListCustomersRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::payment::v1alpha1::ListCustomersResponse>::Create(channel_.get(), cq, rpcmethod_ListCustomers_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::payment::v1alpha1::ListCustomersResponse>* PaymentAPIService::Stub::PrepareAsyncListCustomersRaw(::grpc::ClientContext* context, const ::payment::v1alpha1::ListCustomersRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::payment::v1alpha1::ListCustomersResponse>::Create(channel_.get(), cq, rpcmethod_ListCustomers_, context, request, false);
}

::grpc::Status PaymentAPIService::Stub::ListProjectById(::grpc::ClientContext* context, const ::payment::v1alpha1::ListProjectByIdRequest& request, ::payment::v1alpha1::ListProjectByIdResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_ListProjectById_, context, request, response);
}

void PaymentAPIService::Stub::experimental_async::ListProjectById(::grpc::ClientContext* context, const ::payment::v1alpha1::ListProjectByIdRequest* request, ::payment::v1alpha1::ListProjectByIdResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_ListProjectById_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::payment::v1alpha1::ListProjectByIdResponse>* PaymentAPIService::Stub::AsyncListProjectByIdRaw(::grpc::ClientContext* context, const ::payment::v1alpha1::ListProjectByIdRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::payment::v1alpha1::ListProjectByIdResponse>::Create(channel_.get(), cq, rpcmethod_ListProjectById_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::payment::v1alpha1::ListProjectByIdResponse>* PaymentAPIService::Stub::PrepareAsyncListProjectByIdRaw(::grpc::ClientContext* context, const ::payment::v1alpha1::ListProjectByIdRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::payment::v1alpha1::ListProjectByIdResponse>::Create(channel_.get(), cq, rpcmethod_ListProjectById_, context, request, false);
}
...
::grpc::Status PaymentAPIService::Stub::UpdateProject(::grpc::ClientContext* context, const ::payment::v1alpha1::UpdateProjectRequest& request, ::payment::v1alpha1::UpdateProjectResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_UpdateProject_, context, request, response);
}

void PaymentAPIService::Stub::experimental_async::UpdateProject(::grpc::ClientContext* context, const ::payment::v1alpha1::UpdateProjectRequest* request, ::payment::v1alpha1::UpdateProjectResponse* response, std::function<void(::grpc::Status)> f) {
...
::grpc::ClientAsyncResponseReader< ::payment::v1alpha1::UpdateProjectResponse>* PaymentAPIService::Stub::AsyncUpdateProjectRaw(::grpc::ClientContext* context, const ::payment::v1alpha1::UpdateProjectRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::payment::v1alpha1::UpdateProjectResponse>::Create(channel_.get(), cq, rpcmethod_UpdateProject_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::payment::v1alpha1::UpdateProjectResponse>* PaymentAPIService::Stub::PrepareAsyncUpdateProjectRaw(::grpc::ClientContext* context, const ::payment::v1alpha1::UpdateProjectRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::payment::v1alpha1::UpdateProjectResponse>::Create(channel_.get(), cq, rpcmethod_UpdateProject_, context, request, false);
}
...
PaymentAPIService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< PaymentAPIService::Service, ::payment::v1alpha1::ListCustomersRequest, ::payment::v1alpha1::ListCustomersResponse>(
          std::mem_fn(&PaymentAPIService::Service::ListCustomers), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      PaymentAPIService_method_names[15],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< PaymentAPIService::Service, ::payment::v1alpha1::ListProjectByIdRequest, ::payment::v1alpha1::ListProjectByIdResponse>(
          std::mem_fn(&PaymentAPIService::Service::ListProjectById), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      PaymentAPIService_method_names[25],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< PaymentAPIService::Service, ::payment::v1alpha1::UpdateProjectRequest, ::payment::v1alpha1::UpdateProjectResponse>(
          std::mem_fn(&PaymentAPIService::Service::UpdateProject), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      PaymentAPIService_method_names[26],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      PaymentAPIService_method_names[28],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
...
::grpc::Status PaymentAPIService::Service::ListCustomers(::grpc::ServerContext* context, const ::payment::v1alpha1::ListCustomersRequest* request, ::payment::v1alpha1::ListCustomersResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status PaymentAPIService::Service::ListProjectById(::grpc::ServerContext* context, const ::payment::v1alpha1::ListProjectByIdRequest* request, ::payment::v1alpha1::ListProjectByIdResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status PaymentAPIService::Service::UpdateProject(::grpc::ServerContext* context, const ::payment::v1alpha1::UpdateProjectRequest* request, ::payment::v1alpha1::UpdateProjectResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
