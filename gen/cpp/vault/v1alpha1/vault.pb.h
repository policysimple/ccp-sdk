...
class BlockchainSecret final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:vault.v1alpha1.BlockchainSecret) */ {
 public:
  inline BlockchainSecret() : BlockchainSecret(nullptr) {}
  ~BlockchainSecret() override;
  explicit constexpr BlockchainSecret(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  BlockchainSecret(const BlockchainSecret& from);
  BlockchainSecret(BlockchainSecret&& from) noexcept
    : BlockchainSecret() {
    *this = ::std::move(from);
  }

  inline BlockchainSecret& operator=(const BlockchainSecret& from) {
    CopyFrom(from);
    return *this;
  }
  inline BlockchainSecret& operator=(BlockchainSecret&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const BlockchainSecret& default_instance() {
    return *internal_default_instance();
  }
  static inline const BlockchainSecret* internal_default_instance() {
    return reinterpret_cast<const BlockchainSecret*>(
               &_BlockchainSecret_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(BlockchainSecret& a, BlockchainSecret& b) {
    a.Swap(&b);
  }
  inline void Swap(BlockchainSecret* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(BlockchainSecret* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline BlockchainSecret* New() const final {
    return new BlockchainSecret();
  }

  BlockchainSecret* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<BlockchainSecret>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const BlockchainSecret& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const BlockchainSecret& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to, const ::PROTOBUF_NAMESPACE_ID::Message&from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(BlockchainSecret* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "vault.v1alpha1.BlockchainSecret";
  }
  protected:
  explicit BlockchainSecret(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
inline const std::string& Secret::organization_id() const {
  // @@protoc_insertion_point(field_get:vault.v1alpha1.Secret.organization_id)
  return _internal_organization_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Secret::set_organization_id(ArgT0&& arg0, ArgT... args) {
...
inline std::string* Secret::mutable_organization_id() {
  std::string* _s = _internal_mutable_organization_id();
  // @@protoc_insertion_point(field_mutable:vault.v1alpha1.Secret.organization_id)
  return _s;
}
inline const std::string& Secret::_internal_organization_id() const {
  return organization_id_.Get();
}
inline void Secret::_internal_set_organization_id(const std::string& value) {
  
  organization_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Secret::_internal_mutable_organization_id() {
  
  return organization_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Secret::release_organization_id() {
  // @@protoc_insertion_point(field_release:vault.v1alpha1.Secret.organization_id)
  return organization_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Secret::set_allocated_organization_id(std::string* organization_id) {
  ...
  organization_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), organization_id,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:vault.v1alpha1.Secret.organization_id)
}
...
inline const std::string& Secret::project_id() const {
  // @@protoc_insertion_point(field_get:vault.v1alpha1.Secret.project_id)
  return _internal_project_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Secret::set_project_id(ArgT0&& arg0, ArgT... args) {
...
inline std::string* Secret::mutable_project_id() {
  std::string* _s = _internal_mutable_project_id();
  // @@protoc_insertion_point(field_mutable:vault.v1alpha1.Secret.project_id)
  return _s;
}
inline const std::string& Secret::_internal_project_id() const {
  return project_id_.Get();
}
inline void Secret::_internal_set_project_id(const std::string& value) {
  
  project_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Secret::_internal_mutable_project_id() {
  
  return project_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Secret::release_project_id() {
  // @@protoc_insertion_point(field_release:vault.v1alpha1.Secret.project_id)
  return project_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Secret::set_allocated_project_id(std::string* project_id) {
  ...
  project_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), project_id,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:vault.v1alpha1.Secret.project_id)
}
...
inline bool BlockchainSecret::has_data() const {
  return _internal_has_data();
}
inline void BlockchainSecret::clear_data() {
  if (GetArenaForAllocation() == nullptr && data_ != nullptr) {
    delete data_;
  }
  data_ = nullptr;
}
inline const ::vault::v1alpha1::SecretData& BlockchainSecret::_internal_data() const {
  const ::vault::v1alpha1::SecretData* p = data_;
  return p != nullptr ? *p : reinterpret_cast<const ::vault::v1alpha1::SecretData&>(
      ::vault::v1alpha1::_SecretData_default_instance_);
}
inline const ::vault::v1alpha1::SecretData& BlockchainSecret::data() const {
  // @@protoc_insertion_point(field_get:vault.v1alpha1.BlockchainSecret.data)
  return _internal_data();
}
inline void BlockchainSecret::unsafe_arena_set_allocated_data(
    ::vault::v1alpha1::SecretData* data) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(data_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:vault.v1alpha1.BlockchainSecret.data)
}
inline ::vault::v1alpha1::SecretData* BlockchainSecret::release_data() {
...
inline ::vault::v1alpha1::SecretData* BlockchainSecret::unsafe_arena_release_data() {
  // @@protoc_insertion_point(field_release:vault.v1alpha1.BlockchainSecret.data)
  
  ::vault::v1alpha1::SecretData* temp = data_;
  data_ = nullptr;
  return temp;
}
inline ::vault::v1alpha1::SecretData* BlockchainSecret::_internal_mutable_data() {
...
inline ::vault::v1alpha1::SecretData* BlockchainSecret::mutable_data() {
  ::vault::v1alpha1::SecretData* _msg = _internal_mutable_data();
  // @@protoc_insertion_point(field_mutable:vault.v1alpha1.BlockchainSecret.data)
  return _msg;
}
inline void BlockchainSecret::set_allocated_data(::vault::v1alpha1::SecretData* data) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete data_;
  }
...
inline const std::string& FirebaseSecret::data() const {
  // @@protoc_insertion_point(field_get:vault.v1alpha1.FirebaseSecret.data)
  return _internal_data();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void FirebaseSecret::set_data(ArgT0&& arg0, ArgT... args) {
 
 data_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:vault.v1alpha1.FirebaseSecret.data)
}
inline std::string* FirebaseSecret::mutable_data() {
  std::string* _s = _internal_mutable_data();
  // @@protoc_insertion_point(field_mutable:vault.v1alpha1.FirebaseSecret.data)
  return _s;
}
inline const std::string& FirebaseSecret::_internal_data() const {
  return data_.Get();
}
inline void FirebaseSecret::_internal_set_data(const std::string& value) {
  
  data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* FirebaseSecret::_internal_mutable_data() {
  
  return data_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* FirebaseSecret::release_data() {
  // @@protoc_insertion_point(field_release:vault.v1alpha1.FirebaseSecret.data)
  return data_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void FirebaseSecret::set_allocated_data(std::string* data) {
  if (data != nullptr) {
  ...
  data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:vault.v1alpha1.FirebaseSecret.data)
}
