...
SourceService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_CreateIntegrationWithExternalProvider_(SourceService_method_names[1], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListProviders_(SourceService_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetProvider_(SourceService_method_names[3], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetOneProviderByName_(SourceService_method_names[4], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateProvider_(SourceService_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteProvider_(SourceService_method_names[6], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_AccountsProviders_(SourceService_method_names[7], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateIntegration_(SourceService_method_names[8], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListIntegrations_(SourceService_method_names[9], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetIntegration_(SourceService_method_names[10], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateIntegration_(SourceService_method_names[11], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteIntegration_(SourceService_method_names[12], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteIntegrationsByOrganization_(SourceService_method_names[13], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListRepositoriesProvider_(SourceService_method_names[14], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetRepositoryProvider_(SourceService_method_names[15], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_CreateRepository_(SourceService_method_names[16], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_ListRepositories_(SourceService_method_names[17], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetRepository_(SourceService_method_names[18], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_DeleteRepository_(SourceService_method_names[19], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_UpdateRepository_(SourceService_method_names[20], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status SourceService::Stub::CreateIntegrationWithExternalProvider(::grpc::ClientContext* context, const ::source::v1alpha1::CreateIntegrationWithExternalProviderRequest& request, ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_CreateIntegrationWithExternalProvider_, context, request, response);
}

void SourceService::Stub::experimental_async::CreateIntegrationWithExternalProvider(::grpc::ClientContext* context, const ::source::v1alpha1::CreateIntegrationWithExternalProviderRequest* request, ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_CreateIntegrationWithExternalProvider_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse>* SourceService::Stub::AsyncCreateIntegrationWithExternalProviderRaw(::grpc::ClientContext* context, const ::source::v1alpha1::CreateIntegrationWithExternalProviderRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse>::Create(channel_.get(), cq, rpcmethod_CreateIntegrationWithExternalProvider_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse>* SourceService::Stub::PrepareAsyncCreateIntegrationWithExternalProviderRaw(::grpc::ClientContext* context, const ::source::v1alpha1::CreateIntegrationWithExternalProviderRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse>::Create(channel_.get(), cq, rpcmethod_CreateIntegrationWithExternalProvider_, context, request, false);
}
...
::grpc::Status SourceService::Stub::GetOneProviderByName(::grpc::ClientContext* context, const ::source::v1alpha1::GetOneProviderByNameRequest& request, ::source::v1alpha1::GetOneProviderByNameResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetOneProviderByName_, context, request, response);
}

void SourceService::Stub::experimental_async::GetOneProviderByName(::grpc::ClientContext* context, const ::source::v1alpha1::GetOneProviderByNameRequest* request, ::source::v1alpha1::GetOneProviderByNameResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetOneProviderByName_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::source::v1alpha1::GetOneProviderByNameResponse>* SourceService::Stub::AsyncGetOneProviderByNameRaw(::grpc::ClientContext* context, const ::source::v1alpha1::GetOneProviderByNameRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::source::v1alpha1::GetOneProviderByNameResponse>::Create(channel_.get(), cq, rpcmethod_GetOneProviderByName_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::source::v1alpha1::GetOneProviderByNameResponse>* SourceService::Stub::PrepareAsyncGetOneProviderByNameRaw(::grpc::ClientContext* context, const ::source::v1alpha1::GetOneProviderByNameRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::source::v1alpha1::GetOneProviderByNameResponse>::Create(channel_.get(), cq, rpcmethod_GetOneProviderByName_, context, request, false);
}
...
::grpc::Status SourceService::Stub::AccountsProviders(::grpc::ClientContext* context, const ::source::v1alpha1::AccountsProvidersRequest& request, ::source::v1alpha1::AccountsProvidersResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_AccountsProviders_, context, request, response);
}

void SourceService::Stub::experimental_async::AccountsProviders(::grpc::ClientContext* context, const ::source::v1alpha1::AccountsProvidersRequest* request, ::source::v1alpha1::AccountsProvidersResponse* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_AccountsProviders_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::source::v1alpha1::AccountsProvidersResponse>* SourceService::Stub::AsyncAccountsProvidersRaw(::grpc::ClientContext* context, const ::source::v1alpha1::AccountsProvidersRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::source::v1alpha1::AccountsProvidersResponse>::Create(channel_.get(), cq, rpcmethod_AccountsProviders_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::source::v1alpha1::AccountsProvidersResponse>* SourceService::Stub::PrepareAsyncAccountsProvidersRaw(::grpc::ClientContext* context, const ::source::v1alpha1::AccountsProvidersRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::source::v1alpha1::AccountsProvidersResponse>::Create(channel_.get(), cq, rpcmethod_AccountsProviders_, context, request, false);
}
...
SourceService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SourceService::Service, ::source::v1alpha1::CreateIntegrationWithExternalProviderRequest, ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse>(
          std::mem_fn(&SourceService::Service::CreateIntegrationWithExternalProvider), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SourceService::Service, ::source::v1alpha1::GetOneProviderByNameRequest, ::source::v1alpha1::GetOneProviderByNameResponse>(
          std::mem_fn(&SourceService::Service::GetOneProviderByName), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< SourceService::Service, ::source::v1alpha1::AccountsProvidersRequest, ::source::v1alpha1::AccountsProvidersResponse>(
          std::mem_fn(&SourceService::Service::AccountsProviders), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status SourceService::Service::CreateIntegrationWithExternalProvider(::grpc::ServerContext* context, const ::source::v1alpha1::CreateIntegrationWithExternalProviderRequest* request, ::source::v1alpha1::CreateIntegrationWithExternalProviderResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SourceService::Service::GetOneProviderByName(::grpc::ServerContext* context, const ::source::v1alpha1::GetOneProviderByNameRequest* request, ::source::v1alpha1::GetOneProviderByNameResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status SourceService::Service::AccountsProviders(::grpc::ServerContext* context, const ::source::v1alpha1::AccountsProvidersRequest* request, ::source::v1alpha1::AccountsProvidersResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
