...
inline ::PROTOBUF_NAMESPACE_ID::uint32 UsersRegistry::_internal_organization_id() const {
  return organization_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 UsersRegistry::organization_id() const {
  // @@protoc_insertion_point(field_get:artifacts.users.v1alpha1.UsersRegistry.organization_id)
  return _internal_organization_id();
}
inline void UsersRegistry::_internal_set_organization_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  organization_id_ = value;
}
inline void UsersRegistry::set_organization_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 UsersRegistry::_internal_project_id() const {
  return project_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 UsersRegistry::project_id() const {
  // @@protoc_insertion_point(field_get:artifacts.users.v1alpha1.UsersRegistry.project_id)
  return _internal_project_id();
}
inline void UsersRegistry::_internal_set_project_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  project_id_ = value;
}
inline void UsersRegistry::set_project_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
