...
constexpr CreateOrganizationResponse::CreateOrganizationResponse(
  ...
  , id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , role_id_organization_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
...
constexpr UpdateOrganizationUserPermissionsRequest::UpdateOrganizationUserPermissionsRequest(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : permissions_()
...
struct UpdateOrganizationUserPermissionsRequestDefaultTypeInternal {
  constexpr UpdateOrganizationUserPermissionsRequestDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~UpdateOrganizationUserPermissionsRequestDefaultTypeInternal() {}
  union {
    UpdateOrganizationUserPermissionsRequest _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT UpdateOrganizationUserPermissionsRequestDefaultTypeInternal _UpdateOrganizationUserPermissionsRequest_default_instance_;
constexpr UpdateOrganizationUserPermissionsResponse::UpdateOrganizationUserPermissionsResponse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : msg_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct UpdateOrganizationUserPermissionsResponseDefaultTypeInternal {
  constexpr UpdateOrganizationUserPermissionsResponseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~UpdateOrganizationUserPermissionsResponseDefaultTypeInternal() {}
  union {
    UpdateOrganizationUserPermissionsResponse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT UpdateOrganizationUserPermissionsResponseDefaultTypeInternal _UpdateOrganizationUserPermissionsResponse_default_instance_;
}  // namespace v1
}  // namespace organizations
}  // namespace v1alpha1
}  // namespace accounts
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto[14];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::GetOneOrganizationResponse, status_payment_method_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::Member, image_),
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest, organization_id_),
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest, user_id_),
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest, permissions_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsResponse, msg_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 97, -1, sizeof(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest)},
  { 105, -1, sizeof(::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::accounts::v1alpha1::organizations::v1::_UpdateOrganizationUserPermissionsRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::accounts::v1alpha1::organizations::v1::_UpdateOrganizationUserPermissionsResponse_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto = {
  false, false, 1917, descriptor_table_protodef_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto, "accounts/v1alpha1/organizations/organizations.proto", 
  &descriptor_table_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto_once, descriptor_table_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto_deps, 1, 14,
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.GetOneOrganizationRequest.organization_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* GetOneOrganizationRequest::_InternalSerialize(
  ...
  if (!this->_internal_organization_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.GetOneOrganizationRequest.organization_id");
    target = stream->WriteStringMaybeAliased(
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          auto str = _internal_mutable_organization_id();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.UpdateOrganizationRequest.organization_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* UpdateOrganizationRequest::_InternalSerialize(
  ...
  if (!this->_internal_organization_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_organization_id().data(), static_cast<int>(this->_internal_organization_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.UpdateOrganizationRequest.organization_id");
    target = stream->WriteStringMaybeAliased(
...
GetOneOrganizationResponse::GetOneOrganizationResponse(const GetOneOrganizationResponse& from)
  ...
  status_payment_method_ = from.status_payment_method_;
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&status_payment_method_) -
    reinterpret_cast<char*>(&owner_)) + sizeof(status_payment_method_));
}
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 82)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.GetOneOrganizationResponse.id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 88)) {
          status_payment_method_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* GetOneOrganizationResponse::_InternalSerialize(
  ...
  if (!this->_internal_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.GetOneOrganizationResponse.id");
    target = stream->WriteStringMaybeAliased(
        10, this->_internal_id(), target);
  }

  // bool status_payment_method = 11 [json_name = "statusPaymentMethod"];
  if (this->_internal_status_payment_method() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(11, this->_internal_status_payment_method(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:accounts.v1alpha1.organizations.v1.GetOneOrganizationResponse)
  ...
  if (from._internal_status_payment_method() != 0) {
    _internal_set_status_payment_method(from._internal_status_payment_method());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void GetOneOrganizationResponse::InternalSwap(GetOneOrganizationResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GetOneOrganizationResponse, status_payment_method_)
      + sizeof(GetOneOrganizationResponse::status_payment_method_)
...
CreateOrganizationResponse::CreateOrganizationResponse(const CreateOrganizationResponse& from)
  ...
  role_id_organization_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_role_id_organization().empty()) {
    role_id_organization_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_role_id_organization(), 
      GetArenaForAllocation());
  }
...
inline void CreateOrganizationResponse::SharedDtor() {
  ...
  id_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  role_id_organization_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          auto str = _internal_mutable_id();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.CreateOrganizationResponse.id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string role_id_organization = 6 [json_name = "roleIdOrganization"];
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 50)) {
          auto str = _internal_mutable_role_id_organization();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.CreateOrganizationResponse.role_id_organization"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* CreateOrganizationResponse::_InternalSerialize(
  ...
  if (!this->_internal_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_id().data(), static_cast<int>(this->_internal_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.CreateOrganizationResponse.id");
    target = stream->WriteStringMaybeAliased(
        5, this->_internal_id(), target);
  }

  // string role_id_organization = 6 [json_name = "roleIdOrganization"];
  if (!this->_internal_role_id_organization().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_role_id_organization().data(), static_cast<int>(this->_internal_role_id_organization().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.CreateOrganizationResponse.role_id_organization");
    target = stream->WriteStringMaybeAliased(
        6, this->_internal_role_id_organization(), target);
  }
...
void CreateOrganizationResponse::InternalSwap(CreateOrganizationResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &role_id_organization_, GetArenaForAllocation(),
      &other->role_id_organization_, other->GetArenaForAllocation()
  );
}
...
Member::Member(const Member& from)
  ...
  ::memcpy(&is_active_, &from.is_active_,
    ...
    reinterpret_cast<char*>(&is_active_)) + sizeof(id_));
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 5:
        ...
        continue;
      // repeated .accounts.v1alpha1.MemberRol roles = 6 [json_name = "roles"];
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 50)) {
          ptr -= 1;
          do {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 58)) {
          auto str = _internal_mutable_image();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.Member.image"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // uint32 id = 8 [json_name = "id"];
      case 8:
...
::PROTOBUF_NAMESPACE_ID::uint8* Member::_InternalSerialize(
  ...
  if (!this->_internal_image().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_image().data(), static_cast<int>(this->_internal_image().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.Member.image");
    target = stream->WriteStringMaybeAliased(
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          auto str = _internal_mutable_id();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.ProjectOrganization.id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* ProjectOrganization::_InternalSerialize(
  ...
  if (!this->_internal_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_id().data(), static_cast<int>(this->_internal_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.ProjectOrganization.id");
    target = stream->WriteStringMaybeAliased(
        5, this->_internal_id(), target);
  }
...
class UpdateOrganizationUserPermissionsRequest::_Internal {
 public:
};

UpdateOrganizationUserPermissionsRequest::UpdateOrganizationUserPermissionsRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned),
  permissions_(arena) {
  SharedCtor();
  ...
  // @@protoc_insertion_point(arena_constructor:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
}
UpdateOrganizationUserPermissionsRequest::UpdateOrganizationUserPermissionsRequest(const UpdateOrganizationUserPermissionsRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
  ...
  // @@protoc_insertion_point(copy_constructor:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
}

inline void UpdateOrganizationUserPermissionsRequest::SharedCtor() {
organization_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
user_id_ = 0u;
}

UpdateOrganizationUserPermissionsRequest::~UpdateOrganizationUserPermissionsRequest() {
  // @@protoc_insertion_point(destructor:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void UpdateOrganizationUserPermissionsRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  organization_id_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void UpdateOrganizationUserPermissionsRequest::ArenaDtor(void* object) {
  UpdateOrganizationUserPermissionsRequest* _this = reinterpret_cast< UpdateOrganizationUserPermissionsRequest* >(object);
  (void)_this;
}
void UpdateOrganizationUserPermissionsRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void UpdateOrganizationUserPermissionsRequest::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void UpdateOrganizationUserPermissionsRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* UpdateOrganizationUserPermissionsRequest::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_organization_id();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest.organization_id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt32Parser(_internal_mutable_permissions(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24) {
          _internal_add_permissions(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* UpdateOrganizationUserPermissionsRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_organization_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_organization_id().data(), static_cast<int>(this->_internal_organization_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest.organization_id");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_organization_id(), target);
  }
  ...
  // repeated int32 permissions = 3 [json_name = "permissions"];
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(
          3, _internal_permissions(), byte_size, target);
    }
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
  return target;
}

size_t UpdateOrganizationUserPermissionsRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData UpdateOrganizationUserPermissionsRequest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    UpdateOrganizationUserPermissionsRequest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*UpdateOrganizationUserPermissionsRequest::GetClassData() const { return &_class_data_; }

void UpdateOrganizationUserPermissionsRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<UpdateOrganizationUserPermissionsRequest *>(to)->MergeFrom(
      static_cast<const UpdateOrganizationUserPermissionsRequest &>(from));
}


void UpdateOrganizationUserPermissionsRequest::MergeFrom(const UpdateOrganizationUserPermissionsRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void UpdateOrganizationUserPermissionsRequest::CopyFrom(const UpdateOrganizationUserPermissionsRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool UpdateOrganizationUserPermissionsRequest::IsInitialized() const {
  return true;
}

void UpdateOrganizationUserPermissionsRequest::InternalSwap(UpdateOrganizationUserPermissionsRequest* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata UpdateOrganizationUserPermissionsRequest::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto_getter, &descriptor_table_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto_once,
...
class UpdateOrganizationUserPermissionsResponse::_Internal {
 public:
};

UpdateOrganizationUserPermissionsResponse::UpdateOrganizationUserPermissionsResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
}
UpdateOrganizationUserPermissionsResponse::UpdateOrganizationUserPermissionsResponse(const UpdateOrganizationUserPermissionsResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_msg().empty()) {
  ...
  // @@protoc_insertion_point(copy_constructor:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
}

inline void UpdateOrganizationUserPermissionsResponse::SharedCtor() {
msg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

UpdateOrganizationUserPermissionsResponse::~UpdateOrganizationUserPermissionsResponse() {
  // @@protoc_insertion_point(destructor:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void UpdateOrganizationUserPermissionsResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  msg_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void UpdateOrganizationUserPermissionsResponse::ArenaDtor(void* object) {
  UpdateOrganizationUserPermissionsResponse* _this = reinterpret_cast< UpdateOrganizationUserPermissionsResponse* >(object);
  (void)_this;
}
void UpdateOrganizationUserPermissionsResponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void UpdateOrganizationUserPermissionsResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void UpdateOrganizationUserPermissionsResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* UpdateOrganizationUserPermissionsResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_msg();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse.msg"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* UpdateOrganizationUserPermissionsResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_msg().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_msg().data(), static_cast<int>(this->_internal_msg().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse.msg");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_msg(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
  return target;
}

size_t UpdateOrganizationUserPermissionsResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData UpdateOrganizationUserPermissionsResponse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    UpdateOrganizationUserPermissionsResponse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*UpdateOrganizationUserPermissionsResponse::GetClassData() const { return &_class_data_; }

void UpdateOrganizationUserPermissionsResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<UpdateOrganizationUserPermissionsResponse *>(to)->MergeFrom(
      static_cast<const UpdateOrganizationUserPermissionsResponse &>(from));
}


void UpdateOrganizationUserPermissionsResponse::MergeFrom(const UpdateOrganizationUserPermissionsResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void UpdateOrganizationUserPermissionsResponse::CopyFrom(const UpdateOrganizationUserPermissionsResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:accounts.v1alpha1.organizations.v1.UpdateOrganizationUserPermissionsResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool UpdateOrganizationUserPermissionsResponse::IsInitialized() const {
  return true;
}

void UpdateOrganizationUserPermissionsResponse::InternalSwap(UpdateOrganizationUserPermissionsResponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
::PROTOBUF_NAMESPACE_ID::Metadata UpdateOrganizationUserPermissionsResponse::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto_getter, &descriptor_table_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto_once,
      file_level_metadata_accounts_2fv1alpha1_2forganizations_2forganizations_2eproto[13]);
}
...
template<> PROTOBUF_NOINLINE ::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest* Arena::CreateMaybeMessage< ::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsResponse* Arena::CreateMaybeMessage< ::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::accounts::v1alpha1::organizations::v1::UpdateOrganizationUserPermissionsResponse >(arena);
}
