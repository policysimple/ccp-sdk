...
constexpr ListApplication::ListApplication(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , name_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , project_id_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
...
struct ListApplicationDefaultTypeInternal {
  constexpr ListApplicationDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~ListApplicationDefaultTypeInternal() {}
  union {
    ListApplication _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ListApplicationDefaultTypeInternal _ListApplication_default_instance_;
}  // namespace v1alpha1
}  // namespace application
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_application_2fv1alpha1_2fapplication_2eproto[9];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_application_2fv1alpha1_2fapplication_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::Branch, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::Branch, name_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::Branch, sha_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::Branch, url_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::Repository, branch_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ContainerRegistry, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ContainerRegistry, registry_url_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ContainerRegistry, user_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ContainerRegistry, password_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::Application, container_registry_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ListApplication, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ListApplication, id_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ListApplication, name_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ListApplication, repository_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ListApplication, project_id_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ListApplication, organization_id_),
  PROTOBUF_FIELD_OFFSET(::application::v1alpha1::ListApplication, integration_status_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::application::v1alpha1::Branch)},
  { 8, -1, sizeof(::application::v1alpha1::Repository)},
  { 20, -1, sizeof(::application::v1alpha1::Command)},
  { 27, -1, sizeof(::application::v1alpha1::Env)},
  { 35, -1, sizeof(::application::v1alpha1::Configuration)},
  { 44, -1, sizeof(::application::v1alpha1::Scaling)},
  { 55, -1, sizeof(::application::v1alpha1::ContainerRegistry)},
  { 63, -1, sizeof(::application::v1alpha1::Application)},
  { 84, -1, sizeof(::application::v1alpha1::ListApplication)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::application::v1alpha1::_Branch_default_instance_),
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::application::v1alpha1::_ContainerRegistry_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::application::v1alpha1::_Application_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::application::v1alpha1::_ListApplication_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_application_2fv1alpha1_2fapplication_2eproto = {
  false, false, 2423, descriptor_table_protodef_application_2fv1alpha1_2fapplication_2eproto, "application/v1alpha1/application.proto", 
  &descriptor_table_application_2fv1alpha1_2fapplication_2eproto_once, nullptr, 0, 9,
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* TrafficType_descriptor() {
  ...
  return file_level_enum_descriptors_application_2fv1alpha1_2fapplication_2eproto[0];
}
...
Branch::Branch(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:application.v1alpha1.Branch)
}
Branch::Branch(const Branch& from)
  ...
  // @@protoc_insertion_point(copy_constructor:application.v1alpha1.Branch)
}
...
Branch::~Branch() {
  // @@protoc_insertion_point(destructor:application.v1alpha1.Branch)
...
void Branch::Clear() {
// @@protoc_insertion_point(message_clear_start:application.v1alpha1.Branch)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.Branch.name"));
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.Branch.sha"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.Branch.url"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Branch::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:application.v1alpha1.Branch)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "application.v1alpha1.Branch.name");
  ...
  if (!this->_internal_sha().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.Branch.sha");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_url().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.Branch.url");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:application.v1alpha1.Branch)
  return target;
}

size_t Branch::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:application.v1alpha1.Branch)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:application.v1alpha1.Branch)
...
// @@protoc_insertion_point(class_specific_copy_from_start:application.v1alpha1.Branch)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Repository::_Internal {
 public:
  static const ::application::v1alpha1::Branch& branch(const Repository* msg);
};

const ::application::v1alpha1::Branch&
...
Repository::Repository(const Repository& from)
  ...
  if (from._internal_has_branch()) {
    branch_ = new ::application::v1alpha1::Branch(*from.branch_);
  } else {
    branch_ = nullptr;
  }
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    reinterpret_cast<char*>(&branch_)) + sizeof(private__));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:application.v1alpha1.Repository)
  ...
  if (from._internal_has_branch()) {
    _internal_mutable_branch()->::application::v1alpha1::Branch::MergeFrom(from._internal_branch());
  }
...
ContainerRegistry::ContainerRegistry(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:application.v1alpha1.ContainerRegistry)
}
ContainerRegistry::ContainerRegistry(const ContainerRegistry& from)
  ...
  // @@protoc_insertion_point(copy_constructor:application.v1alpha1.ContainerRegistry)
}
...
ContainerRegistry::~ContainerRegistry() {
  // @@protoc_insertion_point(destructor:application.v1alpha1.ContainerRegistry)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:application.v1alpha1.ContainerRegistry)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.ContainerRegistry.registry_url"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.ContainerRegistry.user"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.ContainerRegistry.password"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* ContainerRegistry::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:application.v1alpha1.ContainerRegistry)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_registry_url().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.ContainerRegistry.registry_url");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_user().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.ContainerRegistry.user");
    target = stream->WriteStringMaybeAliased(
  ...
  if (!this->_internal_password().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.ContainerRegistry.password");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:application.v1alpha1.ContainerRegistry)
  return target;
}

size_t ContainerRegistry::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:application.v1alpha1.ContainerRegistry)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:application.v1alpha1.ContainerRegistry)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:application.v1alpha1.ContainerRegistry)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Application::_Internal {
 public:
  ...
  static const ::application::v1alpha1::ContainerRegistry& container_registry(const Application* msg);
};
...
const ::application::v1alpha1::ContainerRegistry&
...
Application::Application(const Application& from)
  ...
  if (from._internal_has_container_registry()) {
    container_registry_ = new ::application::v1alpha1::ContainerRegistry(*from.container_registry_);
  } else {
    container_registry_ = nullptr;
  }
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 58)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.Application.name_project"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Application::_InternalSerialize(
  ...
  if (!this->_internal_name_project().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.Application.name_project");
    target = stream->WriteStringMaybeAliased(
...
// @@protoc_insertion_point(class_specific_merge_from_start:application.v1alpha1.Application)
  ...
  if (from._internal_has_container_registry()) {
    _internal_mutable_container_registry()->::application::v1alpha1::ContainerRegistry::MergeFrom(from._internal_container_registry());
  }
...
class ListApplication::_Internal {
 public:
  static const ::application::v1alpha1::Repository& repository(const ListApplication* msg);
};

const ::application::v1alpha1::Repository&
ListApplication::_Internal::repository(const ListApplication* msg) {
  return *msg->repository_;
}
ListApplication::ListApplication(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:application.v1alpha1.ListApplication)
}
ListApplication::ListApplication(const ListApplication& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_id().empty()) {
  ...
  integration_status_ = from.integration_status_;
...
ListApplication::~ListApplication() {
  // @@protoc_insertion_point(destructor:application.v1alpha1.ListApplication)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void ListApplication::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  id_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  name_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  project_id_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void ListApplication::ArenaDtor(void* object) {
  ListApplication* _this = reinterpret_cast< ListApplication* >(object);
  (void)_this;
}
void ListApplication::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ListApplication::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void ListApplication::Clear() {
// @@protoc_insertion_point(message_clear_start:application.v1alpha1.ListApplication)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ListApplication::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          auto str = _internal_mutable_id();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.ListApplication.id"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string name = 2 [json_name = "name"];
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          auto str = _internal_mutable_name();
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "application.v1alpha1.ListApplication.name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* ListApplication::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:application.v1alpha1.ListApplication)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_id().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_id().data(), static_cast<int>(this->_internal_id().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.ListApplication.id");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_id(), target);
  }
  ...
  if (!this->_internal_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_name().data(), static_cast<int>(this->_internal_name().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "application.v1alpha1.ListApplication.name");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_name(), target);
  }
  ...
  if (this->_internal_integration_status() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(8, this->_internal_integration_status(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:application.v1alpha1.ListApplication)
  return target;
}

size_t ListApplication::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:application.v1alpha1.ListApplication)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ListApplication::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    ListApplication::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ListApplication::GetClassData() const { return &_class_data_; }

void ListApplication::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<ListApplication *>(to)->MergeFrom(
      static_cast<const ListApplication &>(from));
}


void ListApplication::MergeFrom(const ListApplication& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:application.v1alpha1.ListApplication)
  GOOGLE_DCHECK_NE(&from, this);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void ListApplication::CopyFrom(const ListApplication& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:application.v1alpha1.ListApplication)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ListApplication::IsInitialized() const {
  return true;
}

void ListApplication::InternalSwap(ListApplication* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ListApplication, integration_status_)
      + sizeof(ListApplication::integration_status_)
...
template<> PROTOBUF_NOINLINE ::application::v1alpha1::Branch* Arena::CreateMaybeMessage< ::application::v1alpha1::Branch >(Arena* arena) {
  return Arena::CreateMessageInternal< ::application::v1alpha1::Branch >(arena);
}
...
template<> PROTOBUF_NOINLINE ::application::v1alpha1::ContainerRegistry* Arena::CreateMaybeMessage< ::application::v1alpha1::ContainerRegistry >(Arena* arena) {
  return Arena::CreateMessageInternal< ::application::v1alpha1::ContainerRegistry >(arena);
}
...
template<> PROTOBUF_NOINLINE ::application::v1alpha1::ListApplication* Arena::CreateMaybeMessage< ::application::v1alpha1::ListApplication >(Arena* arena) {
  return Arena::CreateMessageInternal< ::application::v1alpha1::ListApplication >(arena);
}
