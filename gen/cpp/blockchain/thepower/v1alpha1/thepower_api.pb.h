...
// string query_params = 3 [json_name = "queryParams"];
inline void GetTpChainsRequest::clear_query_params() {
  query_params_.ClearToEmpty();
}
inline const std::string& GetTpChainsRequest::query_params() const {
  // @@protoc_insertion_point(field_get:blockchain.thepower.v1alpha1.GetTpChainsRequest.query_params)
  return _internal_query_params();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GetTpChainsRequest::set_query_params(ArgT0&& arg0, ArgT... args) {
 ...
 query_params_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:blockchain.thepower.v1alpha1.GetTpChainsRequest.query_params)
}
inline std::string* GetTpChainsRequest::mutable_query_params() {
  std::string* _s = _internal_mutable_query_params();
  // @@protoc_insertion_point(field_mutable:blockchain.thepower.v1alpha1.GetTpChainsRequest.query_params)
  return _s;
}
inline const std::string& GetTpChainsRequest::_internal_query_params() const {
  return query_params_.Get();
}
inline void GetTpChainsRequest::_internal_set_query_params(const std::string& value) {
  
  query_params_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* GetTpChainsRequest::_internal_mutable_query_params() {
  
  return query_params_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* GetTpChainsRequest::release_query_params() {
  // @@protoc_insertion_point(field_release:blockchain.thepower.v1alpha1.GetTpChainsRequest.query_params)
  return query_params_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void GetTpChainsRequest::set_allocated_query_params(std::string* query_params) {
  ...
  query_params_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), query_params,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:blockchain.thepower.v1alpha1.GetTpChainsRequest.query_params)
}
