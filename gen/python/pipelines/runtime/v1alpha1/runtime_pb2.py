...
_RUNTIME = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='environment_variables', full_name='pipelines.runtime.v1alpha1.Runtime.environment_variables', index=7,
