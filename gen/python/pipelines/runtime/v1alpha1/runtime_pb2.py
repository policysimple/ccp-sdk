...
_RUNTIME = _descriptor.Descriptor(
  ...
  nested_types=[_RUNTIME_INTEGRATIONENTRY, _RUNTIME_ENVIRONMENTVARIABLESENTRY, _RUNTIME_COMMANDSENTRY, _RUNTIME_SECRETSENTRY, ],
  enum_types=[
  ],
