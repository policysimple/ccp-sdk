...
class InstanceAPIService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def CreateInstance(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pipelines.instance.v1alpha1.InstanceAPIService/CreateInstance',
            pipelines_dot_instance_dot_v1alpha1_dot_instance__api__pb2.CreateInstanceRequest.SerializeToString,
            pipelines_dot_instance_dot_v1alpha1_dot_instance__api__pb2.CreateInstanceResponse.FromString,
