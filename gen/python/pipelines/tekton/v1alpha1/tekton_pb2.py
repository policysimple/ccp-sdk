...
_TASKRUN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='task_run', full_name='pipelines.tekton.v1alpha1.TaskRun.task_run', index=7,
...
_TASKRUN.fields_by_name['task_run'].message_type = _TASKRUNSTEP
