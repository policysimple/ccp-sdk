...
_PIPELINE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='active', full_name='pipelines.tekton.v1alpha1.Pipeline.active', index=14,
    ...
    _descriptor.FieldDescriptor(
      name='instance_type', full_name='pipelines.tekton.v1alpha1.Pipeline.instance_type', index=15,
    ...
    _descriptor.FieldDescriptor(
      name='workspaces_main', full_name='pipelines.tekton.v1alpha1.Pipeline.workspaces_main', index=16,
