...
_CUSTOMER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='subscription', full_name='payment.v1alpha1.Customer.subscription', index=5,
