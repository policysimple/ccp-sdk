...
_STOPPROJECTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='project', full_name='payment.v1alpha1.StopProjectRequest.project', index=2,
