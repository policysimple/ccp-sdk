...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=b'\n*io.cuemby.performance.autoscaling.v1alpha1B\030AutoscalingAgentApiProtoP\001Z3github.com/performance-grpc-sdk/autoscalingv1alpha1\242\002\003PFX\252\002 Performance.Autoscaling.V1Alpha1\312\002 Performance\\Autoscaling\\V1Alpha1',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n<performance/autoscaling/v1alpha1/autoscaling_agent_api.proto\x12 performance.autoscaling.v1alpha1\x1a\x32performance/autoscaling/v1alpha1/autoscaling.proto\"p\n\x1d\x41gentCreateAutoscalingRequest\x12O\n\x0b\x61utoscaling\x18\x01 \x01(\x0b\x32-.performance.autoscaling.v1alpha1.AutoscalingR\x0b\x61utoscaling\"\x89\x01\n\x1e\x41gentCreateAutoscalingResponse\x12O\n\x0b\x61utoscaling\x18\x01 \x01(\x0b\x32-.performance.autoscaling.v1alpha1.AutoscalingR\x0b\x61utoscaling\x12\x16\n\x06status\x18\x02 \x01(\tR\x06status\"p\n\x1d\x41gentUpdateAutoscalingRequest\x12O\n\x0b\x61utoscaling\x18\x01 \x01(\x0b\x32-.performance.autoscaling.v1alpha1.AutoscalingR\x0b\x61utoscaling\"\x89\x01\n\x1e\x41gentUpdateAutoscalingResponse\x12O\n\x0b\x61utoscaling\x18\x01 \x01(\x0b\x32-.performance.autoscaling.v1alpha1.AutoscalingR\x0b\x61utoscaling\x12\x16\n\x06status\x18\x02 \x01(\tR\x06status\"g\n\x1d\x41gentDeleteAutoscalingRequest\x12\x46\n\x08metadata\x18\x01 \x01(\x0b\x32*.performance.autoscaling.v1alpha1.MetadataR\x08metadata\"\x80\x01\n\x1e\x41gentDeleteAutoscalingResponse\x12\x46\n\x08metadata\x18\x01 \x01(\x0b\x32*.performance.autoscaling.v1alpha1.MetadataR\x08metadata\x12\x16\n\x06status\x18\x02 \x01(\tR\x06status\"d\n\x1a\x41gentGetAutoscalingRequest\x12\x46\n\x08metadata\x18\x01 \x01(\x0b\x32*.performance.autoscaling.v1alpha1.MetadataR\x08metadata\"\x86\x01\n\x1b\x41gentGetAutoscalingResponse\x12O\n\x0b\x61utoscaling\x18\x01 \x01(\x0b\x32-.performance.autoscaling.v1alpha1.AutoscalingR\x0b\x61utoscaling\x12\x16\n\x06status\x18\x02 \x01(\tR\x06status\"e\n\x1b\x41gentListAutoscalingRequest\x12\x46\n\x08metadata\x18\x01 \x01(\x0b\x32*.performance.autoscaling.v1alpha1.MetadataR\x08metadata\"q\n\x1c\x41gentListAutoscalingResponse\x12Q\n\x0c\x61utoscalings\x18\x01 \x03(\x0b\x32-.performance.autoscaling.v1alpha1.AutoscalingR\x0c\x61utoscalings2\xc1\x06\n\x1a\x41utoscalingAgentAPIService\x12\xa1\x01\n\x16\x41gentCreateAutoscaling\x12?.performance.autoscaling.v1alpha1.AgentCreateAutoscalingRequest\x1a@.performance.autoscaling.v1alpha1.AgentCreateAutoscalingResponse\"\x00(\x01\x30\x01\x12\xa1\x01\n\x16\x41gentUpdateAutoscaling\x12?.performance.autoscaling.v1alpha1.AgentUpdateAutoscalingRequest\x1a@.performance.autoscaling.v1alpha1.AgentUpdateAutoscalingResponse\"\x00(\x01\x30\x01\x12\xa1\x01\n\x16\x41gentDeleteAutoscaling\x12?.performance.autoscaling.v1alpha1.AgentDeleteAutoscalingRequest\x1a@.performance.autoscaling.v1alpha1.AgentDeleteAutoscalingResponse\"\x00(\x01\x30\x01\x12\x98\x01\n\x13\x41gentGetAutoscaling\x12<.performance.autoscaling.v1alpha1.AgentGetAutoscalingRequest\x1a=.performance.autoscaling.v1alpha1.AgentGetAutoscalingResponse\"\x00(\x01\x30\x01\x12\x9b\x01\n\x14\x41gentListAutoscaling\x12=.performance.autoscaling.v1alpha1.AgentListAutoscalingRequest\x1a>.performance.autoscaling.v1alpha1.AgentListAutoscalingResponse\"\x00(\x01\x30\x01\x42\xc9\x01\n*io.cuemby.performance.autoscaling.v1alpha1B\x18\x41utoscalingAgentApiProtoP\x01Z3github.com/performance-grpc-sdk/autoscalingv1alpha1\xa2\x02\x03PFX\xaa\x02 Performance.Autoscaling.V1Alpha1\xca\x02 Performance\\Autoscaling\\V1Alpha1b\x06proto3'
  ,
...
_AGENTCREATEAUTOSCALINGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='autoscaling', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='performance.autoscaling.v1alpha1.AgentCreateAutoscalingResponse.status', index=1,
...
_AGENTUPDATEAUTOSCALINGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='autoscaling', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='performance.autoscaling.v1alpha1.AgentUpdateAutoscalingResponse.status', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AGENTDELETEAUTOSCALINGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='metadata', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='performance.autoscaling.v1alpha1.AgentDeleteAutoscalingResponse.status', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AGENTGETAUTOSCALINGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='metadata', full_name='performance.autoscaling.v1alpha1.AgentGetAutoscalingRequest.metadata', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AGENTGETAUTOSCALINGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='autoscaling', full_name='performance.autoscaling.v1alpha1.AgentGetAutoscalingResponse.autoscaling', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='autoscaling', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='status', full_name='performance.autoscaling.v1alpha1.AgentGetAutoscalingResponse.status', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AGENTLISTAUTOSCALINGREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='metadata', full_name='performance.autoscaling.v1alpha1.AgentListAutoscalingRequest.metadata', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AGENTLISTAUTOSCALINGRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='autoscalings', full_name='performance.autoscaling.v1alpha1.AgentListAutoscalingResponse.autoscalings', index=0,
...
_AGENTGETAUTOSCALINGREQUEST.fields_by_name['metadata'].message_type = performance_dot_autoscaling_dot_v1alpha1_dot_autoscaling__pb2._METADATA
_AGENTGETAUTOSCALINGRESPONSE.fields_by_name['autoscaling'].message_type = performance_dot_autoscaling_dot_v1alpha1_dot_autoscaling__pb2._AUTOSCALING
