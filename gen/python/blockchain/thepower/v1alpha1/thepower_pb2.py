...
_TPCHAIN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='environment', full_name='blockchain.thepower.v1alpha1.TpChain.environment', index=10,
...
_TPCHAIN.fields_by_name['environment'].enum_type = _BLOCKCHAINENV
