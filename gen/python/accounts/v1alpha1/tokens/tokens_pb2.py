...
_LOG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='location', full_name='accounts.v1alpha1.tokens.v1.Log.location', index=7,
