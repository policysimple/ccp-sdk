...
_LISTPROJECTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='organizationId', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user_id', full_name='accounts.v1alpha1.projects.v1.ListProjectRequest.user_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETONEPROJECTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='uid', full_name='accounts.v1alpha1.projects.v1.GetOneProjectResponse.uid', index=9,
    ...
    _descriptor.FieldDescriptor(
      name='organization_uid', full_name='accounts.v1alpha1.projects.v1.GetOneProjectResponse.organization_uid', index=10,
