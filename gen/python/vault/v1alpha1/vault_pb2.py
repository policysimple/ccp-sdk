...
_SECRET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='metadata', full_name='vault.v1alpha1.Secret.metadata', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='data', full_name='vault.v1alpha1.Secret.data', index=5,
      ...
      serialized_options=None, json_name='data', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='warnings', full_name='vault.v1alpha1.Secret.warnings', index=6,
