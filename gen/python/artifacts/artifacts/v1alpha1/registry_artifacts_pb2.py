...
_ARTIFACTSREGISTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='current_tag', full_name='artifacts.artifacts.v1alpha1.ArtifactsRegistry.current_tag', index=13,
      number=14, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='currentTag', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user', full_name='artifacts.artifacts.v1alpha1.ArtifactsRegistry.user', index=14,
    ...
    _descriptor.FieldDescriptor(
      name='user_email', full_name='artifacts.artifacts.v1alpha1.ArtifactsRegistry.user_email', index=15,
...
_LABELARTIFACTS = _descriptor.Descriptor(
  name='LabelArtifacts',
  full_name='artifacts.artifacts.v1alpha1.LabelArtifacts',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='artifacts.artifacts.v1alpha1.LabelArtifacts.id', index=0,
      ...
      serialized_options=None, json_name='id', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='artifacts.artifacts.v1alpha1.LabelArtifacts.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='name', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='description', full_name='artifacts.artifacts.v1alpha1.LabelArtifacts.description', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['LabelArtifacts'] = _LABELARTIFACTS
...
LabelArtifacts = _reflection.GeneratedProtocolMessageType('LabelArtifacts', (_message.Message,), {
  'DESCRIPTOR' : _LABELARTIFACTS,
  '__module__' : 'artifacts.artifacts.v1alpha1.registry_artifacts_pb2'
  # @@protoc_insertion_point(class_scope:artifacts.artifacts.v1alpha1.LabelArtifacts)
  })
_sym_db.RegisterMessage(LabelArtifacts)
