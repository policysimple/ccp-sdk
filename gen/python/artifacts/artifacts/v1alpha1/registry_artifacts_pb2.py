...
_ARTIFACTSREGISTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='author', full_name='artifacts.artifacts.v1alpha1.ArtifactsRegistry.author', index=14,
