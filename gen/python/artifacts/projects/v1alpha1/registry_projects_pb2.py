...
_PROJECTSREGISTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='environment_internal_name', full_name='artifacts.projects.v1alpha1.ProjectsRegistry.environment_internal_name', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='active', full_name='artifacts.projects.v1alpha1.ProjectsRegistry.active', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='harbor', full_name='artifacts.projects.v1alpha1.ProjectsRegistry.harbor', index=6,
