...
_USERSREGISTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='environment_internal_name', full_name='artifacts.users.v1alpha1.UsersRegistry.environment_internal_name', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='active', full_name='artifacts.users.v1alpha1.UsersRegistry.active', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='harbor', full_name='artifacts.users.v1alpha1.UsersRegistry.harbor', index=6,
