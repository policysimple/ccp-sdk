...
_APPLICATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='organization_id', full_name='application.v1alpha1.Application.organization_id', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='scaling', full_name='application.v1alpha1.Application.scaling', index=7,
