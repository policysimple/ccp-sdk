...
_APPLICATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='organization_id', full_name='application.v1alpha1.Application.organization_id', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='scaling', full_name='application.v1alpha1.Application.scaling', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='traffic_type', full_name='application.v1alpha1.Application.traffic_type', index=9,
