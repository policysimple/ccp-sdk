...
class ApplicationServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateApplication = channel.unary_unary(
        ...
        request_serializer=application_dot_v1alpha1_dot_application__pb2.CreateApplicationRequest.SerializeToString,
        response_deserializer=application_dot_v1alpha1_dot_application__pb2.CreateApplicationResponse.FromString,
        )
    self.ListApplication = channel.unary_unary(
        '/application.v1alpha1.ApplicationService/ListApplication',
        request_serializer=application_dot_v1alpha1_dot_application__pb2.ListApplicationRequest.SerializeToString,
        response_deserializer=application_dot_v1alpha1_dot_application__pb2.ListApplicationResponse.FromString,
        )
    self.GetApplication = channel.unary_unary(
        '/application.v1alpha1.ApplicationService/GetApplication',
        request_serializer=application_dot_v1alpha1_dot_application__pb2.GetApplicationRequest.SerializeToString,
        response_deserializer=application_dot_v1alpha1_dot_application__pb2.GetApplicationResponse.FromString,
        )
    self.DeleteApplication = channel.unary_unary(
        '/application.v1alpha1.ApplicationService/DeleteApplication',
        request_serializer=application_dot_v1alpha1_dot_application__pb2.DeleteApplicationRequest.SerializeToString,
        response_deserializer=application_dot_v1alpha1_dot_application__pb2.DeleteApplicationResponse.FromString,
        )
...
def add_ApplicationServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateApplication': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=application_dot_v1alpha1_dot_application__pb2.CreateApplicationRequest.FromString,
          response_serializer=application_dot_v1alpha1_dot_application__pb2.CreateApplicationResponse.SerializeToString,
      ),
      'ListApplication': grpc.unary_unary_rpc_method_handler(
          servicer.ListApplication,
          request_deserializer=application_dot_v1alpha1_dot_application__pb2.ListApplicationRequest.FromString,
          response_serializer=application_dot_v1alpha1_dot_application__pb2.ListApplicationResponse.SerializeToString,
      ),
      'GetApplication': grpc.unary_unary_rpc_method_handler(
          servicer.GetApplication,
          request_deserializer=application_dot_v1alpha1_dot_application__pb2.GetApplicationRequest.FromString,
          response_serializer=application_dot_v1alpha1_dot_application__pb2.GetApplicationResponse.SerializeToString,
      ),
      'DeleteApplication': grpc.unary_unary_rpc_method_handler(
          servicer.DeleteApplication,
          request_deserializer=application_dot_v1alpha1_dot_application__pb2.DeleteApplicationRequest.FromString,
          response_serializer=application_dot_v1alpha1_dot_application__pb2.DeleteApplicationResponse.SerializeToString,
      ),
