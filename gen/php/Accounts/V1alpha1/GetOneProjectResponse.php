...
/**
 * Generated from protobuf message <code>accounts.v1alpha1.GetOneProjectResponse</code>
 */
class GetOneProjectResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.MenberProject members = 8 [json_name = "members"];</code>
     */
    private $members;
    /**
     * Generated from protobuf field <code>.accounts.v1alpha1.UserList owner = 9 [json_name = "owner"];</code>
     */
     ...
     *     @type \Accounts\V1alpha1\MenberProject[]|\Google\Protobuf\Internal\RepeatedField $members
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.MenberProject members = 8 [json_name = "members"];</code>
     * @param \Accounts\V1alpha1\MenberProject[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setMembers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Accounts\V1alpha1\MenberProject::class);
        $this->members = $arr;
