...
/**
 * Generated from protobuf message <code>accounts.v1alpha1.permissions.v1.GroupPermission</code>
 */
class GroupPermission extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    protected $name = '';
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.Permission permissions = 3 [json_name = "permissions"];</code>
     */
    private $permissions;
