...
/**
 * Generated from protobuf message <code>accounts.v1alpha1.roles.v1.Rol</code>
 */
class Rol extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.roles.v1.Permission permissions = 5 [json_name = "permissions"];</code>
     */
    private $permissions;
    /**
     ...
     *     @type \Accounts\V1alpha1\Roles\V1\Permission[]|\Google\Protobuf\Internal\RepeatedField $permissions
     *     @type bool $is_admin
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.roles.v1.Permission permissions = 5 [json_name = "permissions"];</code>
     * @param \Accounts\V1alpha1\Roles\V1\Permission[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPermissions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Accounts\V1alpha1\Roles\V1\Permission::class);
