...
/**
 * Generated from protobuf message <code>accounts.v1alpha1.Country</code>
 */
class Country extends \Google\Protobuf\Internal\Message
{
    ...
    protected $code = '';
    /**
     * Generated from protobuf field <code>string phone_code = 3 [json_name = "phoneCode"];</code>
     */
    protected $phone_code = '';
    /**
     * Generated from protobuf field <code>string emoji = 4 [json_name = "emoji"];</code>
     */
    protected $emoji = '';
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.State states = 5 [json_name = "states"];</code>
     */
    private $states;
    /**
     * Generated from protobuf field <code>uint32 id = 6 [json_name = "id"];</code>
     */
    protected $id = 0;
