...
/**
 * Generated from protobuf message <code>accounts.v1alpha1.countries.v1.GetOneCountryResponse</code>
 */
class GetOneCountryResponse extends \Google\Protobuf\Internal\Message
{
    ...
    protected $emoji = '';
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.countries.v1.State states = 6 [json_name = "states"];</code>
     */
    private $states;
     ...
     *     @type string $emoji
     *     @type \Accounts\V1alpha1\Countries\V1\State[]|\Google\Protobuf\Internal\RepeatedField $states
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.countries.v1.State states = 6 [json_name = "states"];</code>
     * @param \Accounts\V1alpha1\Countries\V1\State[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setStates($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Accounts\V1alpha1\Countries\V1\State::class);
        $this->states = $arr;
