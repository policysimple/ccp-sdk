...
class Member extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.MemberRol roles = 6 [json_name = "roles"];</code>
     */
    private $roles;
    /**
    ...
    protected $image = '';
    /**
     * Generated from protobuf field <code>uint32 id = 8 [json_name = "id"];</code>
     */
    protected $id = 0;
     ...
     *     @type bool $is_active
     *     @type \Accounts\V1alpha1\MemberRol[]|\Google\Protobuf\Internal\RepeatedField $roles
     *     @type string $image
     *     @type int $id
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.MemberRol roles = 6 [json_name = "roles"];</code>
     * @param \Accounts\V1alpha1\MemberRol[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setRoles($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Accounts\V1alpha1\MemberRol::class);
        $this->roles = $arr;
