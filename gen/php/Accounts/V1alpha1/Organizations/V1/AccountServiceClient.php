...
class AccountServiceClient extends \Grpc\BaseStub {
    ...
    public function CreateOrganization(\Accounts\V1alpha1\Organizations\V1\CreateOrganizationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/accounts.v1alpha1.organizations.v1.AccountService/CreateOrganization',
        $argument,
    ...
    public function ListOrganization(\Accounts\V1alpha1\Organizations\V1\ListOrganizationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/accounts.v1alpha1.organizations.v1.AccountService/ListOrganization',
        $argument,
    ...
    public function GetOneOrganization(\Accounts\V1alpha1\Organizations\V1\GetOneOrganizationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/accounts.v1alpha1.organizations.v1.AccountService/GetOneOrganization',
        $argument,
    ...
    public function UpdateOrganization(\Accounts\V1alpha1\Organizations\V1\UpdateOrganizationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/accounts.v1alpha1.organizations.v1.AccountService/UpdateOrganization',
        $argument,
    ...
    public function DeleteOrganization(\Accounts\V1alpha1\Organizations\V1\DeleteOrganizationRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/accounts.v1alpha1.organizations.v1.AccountService/DeleteOrganization',
        $argument,
