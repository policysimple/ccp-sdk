...
/**
 * Generated from protobuf message <code>accounts.v1alpha1.organizations.v1.GetOneOrganizationResponse</code>
 */
class GetOneOrganizationResponse extends \Google\Protobuf\Internal\Message
{
    ...
    protected $image = '';
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.organizations.v1.ProjectOrganization projects = 4 [json_name = "projects"];</code>
     */
    private $projects;
    /**
    ...
    /**
     * Generated from protobuf field <code>repeated .accounts.v1alpha1.organizations.v1.ProjectOrganization projects = 4 [json_name = "projects"];</code>
     * @param \Accounts\V1alpha1\Organizations\V1\ProjectOrganization[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProjects($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Accounts\V1alpha1\Organizations\V1\ProjectOrganization::class);
        $this->projects = $arr;
