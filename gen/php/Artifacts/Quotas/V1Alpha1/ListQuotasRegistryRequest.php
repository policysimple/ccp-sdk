...
class ListQuotasRegistryRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $page = 0;
    /**
     * Generated from protobuf field <code>uint32 page_size = 5 [json_name = "pageSize"];</code>
     */
    ...
    protected $sort = '';
    /**
     * Generated from protobuf field <code>string reference_id = 7 [json_name = "referenceId"];</code>
     */
