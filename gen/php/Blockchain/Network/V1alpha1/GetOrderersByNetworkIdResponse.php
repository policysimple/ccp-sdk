...
/**
 * Generated from protobuf message <code>blockchain.network.v1alpha1.GetOrderersByNetworkIdResponse</code>
 */
class GetOrderersByNetworkIdResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>repeated .blockchain.network.v1alpha1.Orderer orderers = 1 [json_name = "orderers"];</code>
     */
    private $orderers;
    /**
     ...
     *
     *     @type \Blockchain\Network\V1alpha1\Orderer[]|\Google\Protobuf\Internal\RepeatedField $orderers
    ...
    /**
     * Generated from protobuf field <code>repeated .blockchain.network.v1alpha1.Orderer orderers = 1 [json_name = "orderers"];</code>
     * @param \Blockchain\Network\V1alpha1\Orderer[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOrderers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Blockchain\Network\V1alpha1\Orderer::class);
        $this->orderers = $arr;
