...
class PaymentList extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \PaymentV1Alpha1\Payment[]|\Google\Protobuf\Internal\RepeatedField $items
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .payment.v1alpha1.Payment items = 1 [json_name = "items"];</code>
     * @param \PaymentV1Alpha1\Payment[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setItems($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \PaymentV1Alpha1\Payment::class);
        $this->items = $arr;
