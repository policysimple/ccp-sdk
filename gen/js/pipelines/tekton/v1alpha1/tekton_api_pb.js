...
proto.pipelines.tekton.v1alpha1.GetStatusRuntimeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    event: (f = msg.getEvent()) && proto.pipelines.tekton.v1alpha1.Event.toObject(includeInstance, f)
  };
...
proto.pipelines.tekton.v1alpha1.GetStatusRuntimeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.pipelines.tekton.v1alpha1.Event;
      reader.readMessage(value,proto.pipelines.tekton.v1alpha1.Event.deserializeBinaryFromReader);
      msg.setEvent(value);
      break;
    default:
      reader.skipField();
...
proto.pipelines.tekton.v1alpha1.GetStatusRuntimeResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.pipelines.tekton.v1alpha1.Event.serializeBinaryToWriter
    );
  }
};
...
proto.pipelines.tekton.v1alpha1.GetStatusRuntimeResponse.prototype.getEvent = function() {
  return /** @type{?proto.pipelines.tekton.v1alpha1.Event} */ (
    jspb.Message.getWrapperField(this, proto.pipelines.tekton.v1alpha1.Event, 1));
};
