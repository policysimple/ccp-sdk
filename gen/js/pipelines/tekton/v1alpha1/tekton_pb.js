 ...
 * @const
 */
proto.pipelines.tekton.v1alpha1.PipelineRun.repeatedFields_ = [7];
...
proto.pipelines.tekton.v1alpha1.PipelineRun.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pipelineRunStatus: jspb.Message.getFieldWithDefault(msg, 6, ""),
...
/**
 * optional string pipeline_run_status = 6;
 * @return {string}
 */
...
proto.pipelines.tekton.v1alpha1.PipelineRun.prototype.getTaskRunList = function() {
  return /** @type{!Array<!proto.pipelines.tekton.v1alpha1.TaskRun>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pipelines.tekton.v1alpha1.TaskRun, 7));
};
...
proto.pipelines.tekton.v1alpha1.PipelineRun.prototype.addTaskRun = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 7, opt_value, proto.pipelines.tekton.v1alpha1.TaskRun, opt_index);
};
...
proto.pipelines.tekton.v1alpha1.TaskRun.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    taskRunStatus: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
...
/**
 * optional string task_run_status = 4;
 * @return {string}
 */
