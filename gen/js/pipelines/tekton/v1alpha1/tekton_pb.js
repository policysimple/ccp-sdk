...
proto.pipelines.tekton.v1alpha1.Pipeline.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    paramsList: (f = jspb.Message.getRepeatedField(msg, 9)) == null ? undefined : f,
 ...
 * @return {!proto.pipelines.tekton.v1alpha1.Pipeline} returns this
 */
proto.pipelines.tekton.v1alpha1.Pipeline.prototype.addParams = function(value, opt_index) {
