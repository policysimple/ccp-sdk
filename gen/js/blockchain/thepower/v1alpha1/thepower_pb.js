...
proto.blockchain.thepower.v1alpha1.TpNode.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tpicPort: jspb.Message.getFieldWithDefault(msg, 2, ""),
    apiPort: jspb.Message.getFieldWithDefault(msg, 3, ""),
    apisPort: jspb.Message.getFieldWithDefault(msg, 4, ""),
    ccPort: jspb.Message.getFieldWithDefault(msg, 5, ""),
    crosschainExternalList: (f = jspb.Message.getRepeatedField(msg, 6)) == null ? undefined : f
  };
...
/**
 * repeated string crosschain_external = 6;
 * @return {!Array<string>}
 */
 ...
 * @return {!proto.blockchain.thepower.v1alpha1.TpNode} returns this
 */
proto.blockchain.thepower.v1alpha1.TpNode.prototype.addCrosschainExternal = function(value, opt_index) {
