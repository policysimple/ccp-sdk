...
goog.exportSymbol('proto.vault.v1alpha1.FirebaseSecret', null, global);
 ...
 * @constructor
 */
proto.vault.v1alpha1.FirebaseSecret = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.vault.v1alpha1.FirebaseSecret, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.vault.v1alpha1.FirebaseSecret.displayName = 'proto.vault.v1alpha1.FirebaseSecret';
}
 ...
 * @return {!Object}
 */
proto.vault.v1alpha1.FirebaseSecret.prototype.toObject = function(opt_includeInstance) {
  return proto.vault.v1alpha1.FirebaseSecret.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.vault.v1alpha1.FirebaseSecret} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 */
proto.vault.v1alpha1.FirebaseSecret.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.vault.v1alpha1.FirebaseSecret;
  return proto.vault.v1alpha1.FirebaseSecret.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.vault.v1alpha1.FirebaseSecret} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.vault.v1alpha1.FirebaseSecret}
 */
proto.vault.v1alpha1.FirebaseSecret.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.vault.v1alpha1.FirebaseSecret.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.vault.v1alpha1.FirebaseSecret.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.vault.v1alpha1.FirebaseSecret} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
