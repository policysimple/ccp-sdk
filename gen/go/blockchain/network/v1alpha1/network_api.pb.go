...
var file_blockchain_network_v1alpha1_network_api_proto_rawDesc = []byte{
	...
	0x74, 0x77, 0x6f, 0x72, 0x6b, 0x49, 0x64, 0x22, 0x49, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x67, 0x65, 0x22, 0x51, 0x0a, 0x1d, 0x41, 0x64, 0x64, 0x50, 0x65, 0x65, 0x72, 0x54, 0x6f, 0x4f,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x9f, 0x02, 0x0a, 0x14, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x63,
...
var file_blockchain_network_v1alpha1_network_api_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_blockchain_network_v1alpha1_network_api_proto_goTypes = []interface{}{
	...
	(*CreateNetworkResponse)(nil),         // 2: blockchain.network.v1alpha1.CreateNetworkResponse
	(*AddPeerToOrganizationResponse)(nil), // 3: blockchain.network.v1alpha1.AddPeerToOrganizationResponse
	(*Network)(nil),                       // 4: blockchain.network.v1alpha1.Network
}
var file_blockchain_network_v1alpha1_network_api_proto_depIdxs = []int32{
	4, // 0: blockchain.network.v1alpha1.CreateNetworkRequest.network:type_name -> blockchain.network.v1alpha1.Network
	...
	2, // 3: blockchain.network.v1alpha1.BlockchainAPIService.CreateNetwork:output_type -> blockchain.network.v1alpha1.CreateNetworkResponse
	3, // 4: blockchain.network.v1alpha1.BlockchainAPIService.AddPeerToOrganization:output_type -> blockchain.network.v1alpha1.AddPeerToOrganizationResponse
