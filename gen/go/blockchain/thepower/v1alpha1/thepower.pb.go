...
type TpChain struct {
	...
	ChainNumber int32     `protobuf:"varint,1,opt,name=chain_number,json=chainNumber,proto3" json:"chain_number,omitempty"`
	UserId      string    `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	ChainNodes  []*TpNode `protobuf:"bytes,3,rep,name=chain_nodes,json=chainNodes,proto3" json:"chain_nodes,omitempty"`
}
...
type TpNode struct {
	...
	TpicPort           string   `protobuf:"bytes,2,opt,name=tpic_port,json=tpicPort,proto3" json:"tpic_port,omitempty"`
	ApiPort            string   `protobuf:"bytes,3,opt,name=api_port,json=apiPort,proto3" json:"api_port,omitempty"`
	ApisPort           string   `protobuf:"bytes,4,opt,name=apis_port,json=apisPort,proto3" json:"apis_port,omitempty"`
	CcPort             string   `protobuf:"bytes,5,opt,name=cc_port,json=ccPort,proto3" json:"cc_port,omitempty"`
	CrosschainExternal []string `protobuf:"bytes,6,rep,name=crosschain_external,json=crosschainExternal,proto3" json:"crosschain_external,omitempty"`
}
...
func (x *TpNode) GetTpicPort() string {
	if x != nil {
		return x.TpicPort
	}
	return ""
...
func (x *TpNode) GetApiPort() string {
	if x != nil {
		return x.ApiPort
	}
	return ""
...
func (x *TpNode) GetApisPort() string {
	if x != nil {
		return x.ApisPort
	}
	return ""
...
func (x *TpNode) GetCcPort() string {
	if x != nil {
		return x.CcPort
	}
	return ""
...
func (x *TpNode) GetCrosschainExternal() []string {
	if x != nil {
...
var file_blockchain_thepower_v1alpha1_thepower_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x22, 0x8c, 0x01, 0x0a, 0x07,
	0x54, 0x70, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
	...
	,
...
var file_blockchain_thepower_v1alpha1_thepower_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
