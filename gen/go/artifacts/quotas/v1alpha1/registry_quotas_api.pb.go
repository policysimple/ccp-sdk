...
func (x *ListQuotasRegistryRequest) GetOrganizationId() string {
	if x != nil {
...
func (x *ListQuotasRegistryRequest) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *ListQuotaArtifactRegistryRequest) GetOrganizationId() string {
	if x != nil {
		return x.OrganizationId
	}
	return ""
...
func (x *ListQuotaArtifactRegistryRequest) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
