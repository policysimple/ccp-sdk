...
var file_pipelines_tekton_v1alpha1_tekton_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x0b, 0x50, 0x69,
	...
	0x73, 0x22, 0x4f, 0x0a, 0x0f, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x75, 0x6e,
	0x4c, 0x69, 0x73, 0x74, 0x12, 0x3c, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20,
	...
	0x6d, 0x73, 0x42, 0xae, 0x01, 0x0a, 0x23, 0x69, 0x6f, 0x2e, 0x63, 0x75, 0x65, 0x6d, 0x62, 0x79,
	0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x74, 0x65, 0x6b, 0x74, 0x6f,
	0x6e, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x0b, 0x54, 0x65, 0x6b, 0x74,
...
var file_pipelines_tekton_v1alpha1_tekton_proto_goTypes = []interface{}{
	...
	nil,                           // 11: pipelines.tekton.v1alpha1.Pipeline.IntegrationEntry
	nil,                           // 12: pipelines.tekton.v1alpha1.Pipeline.EnvironmentVariablesEntry
	nil,                           // 13: pipelines.tekton.v1alpha1.Pipeline.CommandsEntry
	nil,                           // 14: pipelines.tekton.v1alpha1.Pipeline.SecretsEntry
	nil,                           // 15: pipelines.tekton.v1alpha1.Pipeline.ExtraArgsEntry
	nil,                           // 16: pipelines.tekton.v1alpha1.Pipeline.InstanceTypeEntry
}
var file_pipelines_tekton_v1alpha1_tekton_proto_depIdxs = []int32{
	...
	11, // 4: pipelines.tekton.v1alpha1.Pipeline.integration:type_name -> pipelines.tekton.v1alpha1.Pipeline.IntegrationEntry
	12, // 5: pipelines.tekton.v1alpha1.Pipeline.environment_variables:type_name -> pipelines.tekton.v1alpha1.Pipeline.EnvironmentVariablesEntry
	13, // 6: pipelines.tekton.v1alpha1.Pipeline.commands:type_name -> pipelines.tekton.v1alpha1.Pipeline.CommandsEntry
	14, // 7: pipelines.tekton.v1alpha1.Pipeline.secrets:type_name -> pipelines.tekton.v1alpha1.Pipeline.SecretsEntry
	15, // 8: pipelines.tekton.v1alpha1.Pipeline.extra_args:type_name -> pipelines.tekton.v1alpha1.Pipeline.ExtraArgsEntry
	16, // 9: pipelines.tekton.v1alpha1.Pipeline.instance_type:type_name -> pipelines.tekton.v1alpha1.Pipeline.InstanceTypeEntry
	...
	9,  // 16: pipelines.tekton.v1alpha1.PipelineRunList.items:type_name -> pipelines.tekton.v1alpha1.PipelineRun
