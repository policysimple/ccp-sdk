...
type TaskParamsToCustomize struct {
	...
	TypeValue  []string `protobuf:"bytes,4,rep,name=type_value,json=typeValue,proto3" json:"type_value,omitempty"`
}
...
var file_pipelines_tekton_v1alpha1_tekton_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09,
