...
var file_accounts_v1alpha1_invitations_invitations_api_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xe7, 0x05, 0x0a, 0x11, 0x49, 0x6e, 0x76,
	...
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74,
...
var file_accounts_v1alpha1_invitations_invitations_api_proto_goTypes = []interface{}{
	...
	(*SendInvitationUserResponse)(nil),  // 5: accounts.v1alpha1.invitations.v1.SendInvitationUserResponse
	(*GetInvitationUserResponse)(nil),   // 6: accounts.v1alpha1.invitations.v1.GetInvitationUserResponse
	(*AgreeInvitationUserResponse)(nil), // 7: accounts.v1alpha1.invitations.v1.AgreeInvitationUserResponse
	(*ListInvitationSendResponse)(nil),  // 8: accounts.v1alpha1.invitations.v1.ListInvitationSendResponse
	(*DeleteInvitationResponse)(nil),    // 9: accounts.v1alpha1.invitations.v1.DeleteInvitationResponse
}
var file_accounts_v1alpha1_invitations_invitations_api_proto_depIdxs = []int32{
	...
	5, // 5: accounts.v1alpha1.invitations.v1.InvitationService.SendInvitationUser:output_type -> accounts.v1alpha1.invitations.v1.SendInvitationUserResponse
	6, // 6: accounts.v1alpha1.invitations.v1.InvitationService.GetInvitationUser:output_type -> accounts.v1alpha1.invitations.v1.GetInvitationUserResponse
	7, // 7: accounts.v1alpha1.invitations.v1.InvitationService.AgreeInvitationUser:output_type -> accounts.v1alpha1.invitations.v1.AgreeInvitationUserResponse
	8, // 8: accounts.v1alpha1.invitations.v1.InvitationService.ListInvitationSend:output_type -> accounts.v1alpha1.invitations.v1.ListInvitationSendResponse
	9, // 9: accounts.v1alpha1.invitations.v1.InvitationService.DeleteInvitation:output_type -> accounts.v1alpha1.invitations.v1.DeleteInvitationResponse
