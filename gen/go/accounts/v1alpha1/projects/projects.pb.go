...
func (x *MemberProject) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *MemberProject) GetProjects() []*ProjectList {
	if x != nil {
		return x.Projects
	}
	return nil
...
type GetOneProjectResponse struct {
	...
	Members        []*MemberProject `protobuf:"bytes,8,rep,name=members,proto3" json:"members,omitempty"`
...
func (x *GetOneProjectResponse) GetMembers() []*MemberProject {
	if x != nil {
		return x.Members
	}
	return nil
...
var file_accounts_v1alpha1_projects_projects_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x4a, 0x0a, 0x09, 0x4d, 0x65, 0x6d,
	...
	0x02, 0x0a, 0x0d, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	...
	0x74, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x6a,
...
var file_accounts_v1alpha1_projects_projects_proto_goTypes = []interface{}{
	...
	(*MemberRol)(nil),                     // 5: accounts.v1alpha1.projects.v1.MemberRol
	(*ProjectList)(nil),                   // 6: accounts.v1alpha1.projects.v1.ProjectList
	(*MemberProject)(nil),                 // 7: accounts.v1alpha1.projects.v1.MemberProject
...
var file_accounts_v1alpha1_projects_projects_proto_depIdxs = []int32{
	...
	6,  // 1: accounts.v1alpha1.projects.v1.MemberProject.projects:type_name -> accounts.v1alpha1.projects.v1.ProjectList
	7,  // 2: accounts.v1alpha1.projects.v1.GetOneProjectResponse.members:type_name -> accounts.v1alpha1.projects.v1.MemberProject
