...
var file_accounts_v1alpha1_accounts_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x98, 0x02,
	...
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x22, 0xf1, 0x09, 0x0a, 0x0a, 0x55, 0x73, 0x65,
...
var file_accounts_v1alpha1_accounts_proto_depIdxs = []int32{
	...
	4, // 5: accounts.v1alpha1.Organization.projects:type_name -> accounts.v1alpha1.Project
	0, // 6: accounts.v1alpha1.UserDetail.roles:type_name -> accounts.v1alpha1.Role
	3, // 7: accounts.v1alpha1.UserDetail.permissions:type_name -> accounts.v1alpha1.Permission
	5, // 8: accounts.v1alpha1.UserDetail.organizations:type_name -> accounts.v1alpha1.Organization
